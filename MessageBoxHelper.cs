...
namespace EngineeringGUI
{
    ...
    {
        internal static void PrepToCenterMessageBoxOnForm(System.Windows.Forms.Form form)
...

        {
            ...
            public void Prep(System.Windows.Forms.Form form)
            {
...

            {
...

                {
                    ...
                    NativeMethods.GetWindowRect(new System.IntPtr(wParam), out messageBoxRect);
